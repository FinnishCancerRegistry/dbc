...
#' @rdname assertions
#' @export
assert_prod_output_all_are_TRUE <- function(
  x,
  x_nm = NULL,
  call = NULL
) {
...
#' @rdname assertions
#' @export
assert_prod_output_data_table_has_no_duplicates <- function(
  x,
  x_nm = NULL,
  call = NULL,
  by = names(x)
...
#' @rdname assertions
#' @export
assert_prod_output_has_no_duplicates <- function(
  x,
  x_nm = NULL,
  call = NULL
) {
...
#' @rdname assertions
#' @export
assert_prod_output_has_only_valid_observations <- function(
  x,
  x_nm = NULL,
  expressions,
  fail_messages = NULL,
...
#' @rdname assertions
#' @export
assert_prod_output_is_all_equal <- function(
  x,
  x_nm = NULL,
  call = NULL,
  y,
...
#' @rdname assertions
#' @export
assert_prod_output_is_assertion_type <- function(
  x,
  x_nm = NULL,
  call = NULL
) {
...
#' @rdname assertions
#' @export
assert_prod_output_is_function_with_required_argument_names <- function(
  x,
  x_nm = NULL,
  call = NULL,
...
#' @rdname assertions
#' @export
assert_prod_output_is_identical <- function(
  x,
  x_nm = NULL,
  call = NULL,
  y,
...
#' @rdname assertions
#' @export
assert_prod_output_is_like_template <- function(
  x,
  x_nm = NULL,
  call = NULL,
  template,
...
#' @rdname assertions
#' @export
assert_prod_output_is_report_df <- function(
  x,
  x_nm = NULL,
  call = NULL
) {
...
#' @rdname assertions
#' @export
assert_prod_output_is_TRUE <- function(
  x,
  x_nm = NULL,
  call = NULL
) {
...
#' @rdname assertions
#' @export
assert_prod_output_match_regex <- function(
  x,
  x_nm = NULL,
  call = NULL,
  grepl.arg.list = list()
