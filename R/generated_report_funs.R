...
report_atom_is_in_set <- function(
  ...
  fail_messages <- 
    c(NA, NA, "object `${x_nm}` = ${x} was not in set of expected values (first ten): ${deparse(utils::head(set, 10L))}")
  pass_messages <- 
...
report_has_class <- function(
  ...
  fail_messages <- 
    c("Internal error: expected required_class to be a non-NA character string (vector of length one), but required_class = ${deparse(required_class)} ", "expected object `${x_nm}` to have class ${required_class}, but it had class(es) ${deparse(class(x))}")
  pass_messages <- 
...
report_has_names <- function(
  ...
  fail_messages <- 
    c(NA, "object `${x_nm}` did not have any names", "object `${x_nm}` did not have the following expected names: ${deparse(miss_nms)}")
  pass_messages <- 
    c(NA_character_, NA_character_, NA_character_)
  report_env <- environment()
  report_df <- dbc::expressions_to_report(
...
report_has_one_of_classes <- function(
  ...
  fail_messages <- 
    c(NA, "expected object `${x_nm}` to have class ${classes}, but it had class(es) ${deparse(class(x))}")
  pass_messages <- 
    c(NA_character_, NA_character_)
  report_env <- environment()
  report_df <- dbc::expressions_to_report(
...
report_has_only_names <- function(
  ...
  fail_messages <- 
    c(NA, "object `${x_nm}` did not have any names", "object `${x_nm}` did not have the following expected names: ${deparse(miss_nms)}", "object `${x_nm}` had the following unexpected names: ${deparse(extra_nms)}")
  pass_messages <- 
...
report_is_between_exclusive <- function(
  ...
  fail_messages <- 
    c(NA, NA, "${n_fail} elements of `${x_nm}` were outside exclusive bounds ${lo}, ${hi}")
  pass_messages <- 
    c(NA_character_, NA_character_, NA_character_)
  report_env <- environment()
  report_df <- dbc::expressions_to_report(
...
report_is_between_inclusive <- function(
  ...
  fail_messages <- 
    c(NA, NA, "${n_fail} elements of `${x_nm}` were outside inclusive bounds ${lo}, ${hi}")
  pass_messages <- 
    c(NA_character_, NA_character_, NA_character_)
  report_env <- environment()
  report_df <- dbc::expressions_to_report(
...
report_is_character_nonNA_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "is.character(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_character_nonNA_matrix <- function(
  ...
  expressions <- 
    c("is.character(x)", "is.matrix(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_character_nonNA_vector <- function(
  ...
  expressions <- 
    c("is.character(x)", "if (!is.function(x)) !is.na(x) else TRUE", "is.null(dim(x))", "!is.list(x)")
  fail_messages <- 
...
report_is_data.frame_with_required_names <- function(
  ...
  fail_messages <- 
    c(NA, "object `${x_nm}` was not a data.frame; instead it had class(es) ${deparse(class(x))}", "object `${x_nm}` did not have the following expected columns: ${deparse(miss_nms)}")
  pass_messages <- 
    c(NA_character_, NA_character_, NA_character_)
  report_env <- environment()
  report_df <- dbc::expressions_to_report(
...
report_is_data.table_with_required_names <- function(
  ...
  fail_messages <- 
    c(NA, "object `${x_nm}` was not a data.table; instead it had class(es) ${deparse(class(x))}", "object `${x_nm}` did not have the following expected columns: ${deparse(miss_nms)}")
  pass_messages <- 
    c(NA_character_, NA_character_, NA_character_)
  report_env <- environment()
  report_df <- dbc::expressions_to_report(
...
report_is_Date_nonNA_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "inherits(x, 'Date')", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_Date_nonNA_matrix <- function(
  ...
  expressions <- 
    c("inherits(x, 'Date')", "is.matrix(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_Date_nonNA_vector <- function(
  ...
  expressions <- 
    c("inherits(x, 'Date')", "if (!is.function(x)) !is.na(x) else TRUE", "is.null(dim(x))", "!is.list(x)")
  fail_messages <- 
...
report_is_double_nonNA_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "is.double(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_double_nonNA_gtezero_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "is.double(x)", "x >= 0", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_double_nonNA_gtezero_matrix <- function(
  ...
  expressions <- 
    c("is.double(x)", "x >= 0", "is.matrix(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_double_nonNA_gtezero_vector <- function(
  ...
  expressions <- 
    c("is.double(x)", "x >= 0", "if (!is.function(x)) !is.na(x) else TRUE", "is.null(dim(x))", "!is.list(x)")
  fail_messages <- 
...
report_is_double_nonNA_matrix <- function(
  ...
  expressions <- 
    c("is.double(x)", "is.matrix(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_double_nonNA_vector <- function(
  ...
  expressions <- 
    c("is.double(x)", "if (!is.function(x)) !is.na(x) else TRUE", "is.null(dim(x))", "!is.list(x)")
  fail_messages <- 
...
report_is_factor_nonNA_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "is.factor(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_factor_nonNA_matrix <- function(
  ...
  expressions <- 
    c("is.factor(x)", "is.matrix(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_factor_nonNA_vector <- function(
  ...
  expressions <- 
    c("is.factor(x)", "if (!is.function(x)) !is.na(x) else TRUE", "is.null(dim(x))", "!is.list(x)")
  fail_messages <- 
...
report_is_factor_with_levels <- function(
  ...
  fail_messages <- 
    c(NA, "object `${x_nm}` is not a factor; instead it had class(es) ${deparse(class(x))}", "factor object `${x_nm}` had these unexpected levels: ${deparse(extra_levels)}", "factor object `${x_nm}` did not have these expected levels: ${deparse(miss_levels)}")
  pass_messages <- 
    c(NA_character_, NA_character_, NA_character_, NA_character_)
  report_env <- environment()
  report_df <- dbc::expressions_to_report(
...
report_is_integer_gtezero_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "x >= 0", "is.integer(x)")
  fail_messages <- 
...
report_is_integer_gtezero_matrix <- function(
  ...
  expressions <- 
    c("x >= 0", "is.integer(x)", "is.matrix(x)")
  fail_messages <- 
...
report_is_integer_ltezero_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "is.integer(x)", "x <= 0")
  fail_messages <- 
...
report_is_integer_ltezero_matrix <- function(
  ...
  expressions <- 
    c("is.integer(x)", "x <= 0", "is.matrix(x)")
  fail_messages <- 
...
report_is_integer_nonNA_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "is.integer(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_integer_nonNA_gtezero_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "x >= 0", "is.integer(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_integer_nonNA_gtezero_matrix <- function(
  ...
  expressions <- 
    c("x >= 0", "is.integer(x)", "is.matrix(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_integer_nonNA_gtezero_vector <- function(
  ...
  expressions <- 
    c("x >= 0", "is.integer(x)", "if (!is.function(x)) !is.na(x) else TRUE", "is.null(dim(x))", "!is.list(x)")
  fail_messages <- 
...
report_is_integer_nonNA_ltezero_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "is.integer(x)", "x <= 0", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_integer_nonNA_ltezero_matrix <- function(
  ...
  expressions <- 
    c("is.integer(x)", "x <= 0", "is.matrix(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_integer_nonNA_ltezero_vector <- function(
  ...
  expressions <- 
    c("is.integer(x)", "x <= 0", "if (!is.function(x)) !is.na(x) else TRUE", "is.null(dim(x))", "!is.list(x)")
  fail_messages <- 
...
report_is_integer_nonNA_matrix <- function(
  ...
  expressions <- 
    c("is.integer(x)", "is.matrix(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_integer_nonNA_vector <- function(
  ...
  expressions <- 
    c("is.integer(x)", "if (!is.function(x)) !is.na(x) else TRUE", "is.null(dim(x))", "!is.list(x)")
  fail_messages <- 
...
report_is_logical_nonNA_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "is.logical(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_logical_nonNA_matrix <- function(
  ...
  expressions <- 
    c("is.logical(x)", "is.matrix(x)", "if (!is.function(x)) !is.na(x) else TRUE")
  fail_messages <- 
...
report_is_logical_nonNA_vector <- function(
  ...
  expressions <- 
    c("is.logical(x)", "if (!is.function(x)) !is.na(x) else TRUE", "is.null(dim(x))", "!is.list(x)")
  fail_messages <- 
...
report_is_number_gtezero_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "x >= 0", "is.numeric(x)")
  fail_messages <- 
...
report_is_number_gtezero_matrix <- function(
  ...
  expressions <- 
    c("x >= 0", "is.matrix(x)", "is.numeric(x)")
  fail_messages <- 
...
report_is_number_nonNA_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "if (!is.function(x)) !is.na(x) else TRUE", "is.numeric(x)")
  fail_messages <- 
...
report_is_number_nonNA_gtezero_atom <- function(
  ...
  expressions <- 
    c("length(x) == 1L", "x >= 0", "if (!is.function(x)) !is.na(x) else TRUE", "is.numeric(x)")
  fail_messages <- 
...
report_is_number_nonNA_gtezero_matrix <- function(
  ...
  expressions <- 
    c("x >= 0", "is.matrix(x)", "if (!is.function(x)) !is.na(x) else TRUE", "is.numeric(x)")
  fail_messages <- 
...
report_is_number_nonNA_gtezero_vector <- function(
  ...
  expressions <- 
    c("x >= 0", "if (!is.function(x)) !is.na(x) else TRUE", "is.numeric(x)", "is.null(dim(x))", "!is.list(x)")
  fail_messages <- 
...
report_is_number_nonNA_matrix <- function(
  ...
  expressions <- 
    c("is.matrix(x)", "if (!is.function(x)) !is.na(x) else TRUE", "is.numeric(x)")
  fail_messages <- 
...
report_is_number_nonNA_vector <- function(
  ...
  expressions <- 
    c("if (!is.function(x)) !is.na(x) else TRUE", "is.numeric(x)", "is.null(dim(x))", "!is.list(x)")
  fail_messages <- 
...
report_vector_elems_are_in_set <- function(
  ...
  fail_messages <- 
    c(NA, "some values of object `${x_nm}` were not in set of expected values. First ten bad values: ${deparse1(utils::head(unique(x[!in_set]), 10L))}. First ten elements in set of expected values: ${deparse1(utils::head(set, 10L))}")
  pass_messages <- 
    c(NA_character_, NA_character_)
  report_env <- environment()
  report_df <- dbc::expressions_to_report(
