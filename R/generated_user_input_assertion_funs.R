...
#' @rdname assertions
#' @export
assert_user_input_has_only_valid_observations <- function(
  x, 
  x_nm = NULL, 
  expressions, 
  fail_messages = NULL, 
...
#' @rdname assertions
#' @export
assert_user_input_is_all_equal <- function(
  x, 
  x_nm = NULL, 
  call = NULL, 
  y, 
...
#' @rdname assertions
#' @export
assert_user_input_is_identical <- function(
  x, 
  x_nm = NULL, 
  call = NULL, 
  y, 
...
#' @rdname assertions
#' @export
assert_user_input_is_like_template <- function(
  x, 
  x_nm = NULL, 
  call = NULL, 
  template, 
